...
$(document).ready(function($) {
	...
	$('body').append("<div id='PP-updateSubmit-Container'><form method='POST' action='http://127.0.0.1:8888/desk/applicationSave.do' id='PP-updateSubmit'>"+
	...
	$("#PP-updateSubmit-Container").dialog({position:"top", height:"150", width:"400",autoOpen:false});
