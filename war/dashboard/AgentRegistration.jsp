...
<form action="createMaster.do" method="post">
	<input type="hidden" name="regType" value="agent"/> 
	...
	<br/>
	<h3>Default Agency</h3>
	Sub Agents cannot see your agencies, all their applications will be queued to the default agency. <br/>
	You can add more agencies later from your account.
	<input type=text name="agency"pattern="[A-z ]{3,25}" title="only letters A-z and spaces, maximum 25 letters" maxlength="25"/>
